...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        with st.expander("🔑 API Keys", expanded=False):
            ...
            st.info("This demo comes with default API keys for two (2) search. To perform more search, please add your " \
            "own keys. Your keys are not stored in the system.")
            if provider == "OpenAI":
            ...
            # Show SERPER key input for web searcher
        ...
        with st.expander("ℹ️ About", expanded=False):
            st.markdown("""
                This agentic research assistant uses advanced AI models to help you:
                ...
                **Note on Model Selection:**
                ...
                - Ollama models run locally but have limited function-calling abilities. Consider
                        fine-tuning them on your data for better performance.
